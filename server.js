...
app.get('/ping', async (req, res) => {
    const requestOptions = {
        'method': 'GET',
        'headers': {
            'x-api-key': 'p8eqqvkph27mp9hrxebyx3re',
        },
    };
...
*/
const clientID = 'p8eqqvkph27mp9hrxebyx3re';
const clientVerifier = 'Ihqf2GMWW-dn12eezVeqNzxexRTVDzXQyIHuxlieVgI';
const redirectUri = 'https://horal-extensions.000webhostapp.com';

app.get("https://horal-extensions.000webhostapp.com", async (req, res) => {
